...
4. Read the `persona.md` briefly to confirm the frontmatter (`display_name`, `categories`, `primary_category`, `tagline`). Report in one or two lines, including the origin:
